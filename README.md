...
For detailed implementation, please read the code at Tennis.ipynb and Report.md. Approach for solving the problem was as below:

- Examine the State and Action Spaces
- Take Random Actions in the Environment
- Train the agent with MultiDDPG
